/**
 * ISO 3166-1 alpha-2 to continent name mapping
 * Source: country.io/continent (AF, AN, AS, EU, NA, OC, SA)
 */
...
// Full mapping from country.io data
const ISO_A2_TO_CONTINENT = {
...
export function getContinentFromISO(isoA2) {
  const code = ISO_A2_TO_CONTINENT[isoA2] || ISO_A2_TO_CONTINENT[isoA2?.toUpperCase()]
  return code ? ISO_TO_CONTINENT[code] : null
}

export { ISO_TO_CONTINENT, ISO_A2_TO_CONTINENT }
